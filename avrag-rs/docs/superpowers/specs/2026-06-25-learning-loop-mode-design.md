...
| 方法 | 路径 | 用途 |
|------|------|------|
| `POST` | `/api/v1/workspaces/{id}/learning/goals` | 创建学习目标 |
| `GET` | `/api/v1/workspaces/{id}/learning/goals/{goal_id}` | 获取学习目标与进度 |
| `POST` | `/api/v1/workspaces/{id}/learning/goals/{goal_id}/runs` | 创建或恢复一次教学 run |
| `POST` | `/api/v1/workspaces/{id}/learning/runs/{run_id}/next` | 推进到下一步教学动作 |
| `POST` | `/api/v1/workspaces/{id}/learning/runs/{run_id}/answers` | 提交微测验答案并评分 |
| `GET` | `/api/v1/workspaces/{id}/learning/runs/{run_id}/events` | 获取 run 日志，用于恢复和排查 |
| `GET` | `/api/v1/workspaces/{id}/learning/mastery` | 查看掌握度地图 |
