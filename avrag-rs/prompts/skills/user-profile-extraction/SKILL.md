...
description: "Load when extracting user preferences and profile information from conversation history. This skill runs in the post-process dream layer: it reads recent session summaries and proposes a semantic delta for the user's long-term structured profile. It must never invent preferences, must avoid PII, and must align tag values with the active skill catalog."
version: "1.0"
inference_version: "dream-v2"
depends: []
