...
pub use handlers::{
    ...
    handle_get_shared_notebook, handle_invite_member, handle_list_members, handle_remove_member,
...
pub use types::{
    ...
    ShareService, ShareSettings, ShareTokenInfo, SharedKnowledgeBase, SharedNotebookPayload,
