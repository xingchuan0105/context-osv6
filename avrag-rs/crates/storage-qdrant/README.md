...
> Status: deprecated legacy rollback adapter.
...
Migration note:
- Qdrant is only selected when `RETRIEVAL_BACKEND=legacy`.
- Existing Qdrant payload and ACL behavior should be preserved as a rollback compatibility contract.
