...
impl AnalyticsContext {
    ...
    pub async fn record_cost_event(&self, record: CostEventRecord<'_>) {
        ...
        let event = analytics::CostEvent {
            ...
            provider: crate::lib_impl::state_methods::non_empty_or_unknown(&record.usage.provider),
            model: crate::lib_impl::state_methods::non_empty_or_unknown(&record.usage.model),
    ...
    pub async fn record_external_search_cost_event(
        ...
        let event = analytics::CostEvent {
            ...
            provider: crate::lib_impl::state_methods::non_empty_or_unknown(provider),
            model: crate::lib_impl::state_methods::non_empty_or_unknown(model),
            prompt_tokens: 0,
            completion_tokens: 0,
            embedding_tokens: 0,
            usage_units: 0,
