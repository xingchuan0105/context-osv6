#[allow(dead_code)]
pub(super) fn build_plan_payloads(
...
pub(super) async fn get_current_subscription(
...
pub(super) async fn load_plan_quotas(
    repo: Arc<PgAppRepository>,
...
pub(super) async fn current_metric_usage(
    repo: Arc<PgAppRepository>,
    user_id: UserId,
    metric_type: &str,
) -> Result<i64> {
...
pub(super) async fn load_quota_limit(
    repo: Arc<PgAppRepository>,
    plan_id: &str,
    metric_type: &str,
...
pub(super) async fn load_customer_id(
    repo: Arc<PgAppRepository>,
    user_id: UserId,
...
pub(super) async fn load_user_plan_id(
    repo: Arc<PgAppRepository>,
    user_id: UserId,
) -> Result<String> {
...
pub(super) async fn load_usage_window(
    repo: Arc<PgAppRepository>,
    user_id: UserId,
...
pub(super) async fn load_usage_forecast(
    repo: Arc<PgAppRepository>,
    user_id: UserId,
