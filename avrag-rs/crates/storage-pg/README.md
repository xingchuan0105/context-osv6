...
- Postgres is the product control plane: users, organizations, workspaces, auth/session, chat history, agent memory metadata, ingestion jobs, audit, usage, billing, and document lifecycle state.
