...
pub fn ChatPanel(
    ...
    view! {
        <div class="relative flex h-full flex-col">
            <div class="z-10 flex items-center justify-between border-b border-border bg-card px-4 py-3 shadow-sm">
            ...
            <div
                class="relative flex-1 overflow-y-auto bg-background p-4 pb-32"
            ...
            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background via-background to-transparent p-4 pt-10">
                <div class="relative mx-auto max-w-4xl rounded-2xl border border-border bg-card p-2 shadow-popover transition-shadow focus-within:border-primary/50 focus-within:shadow-md">
                    <form
                        on:submit=move |ev| {
                            ev.prevent_default();
                    ...
                    >
                        <textarea
                            class="w-full resize-none bg-transparent px-3 py-2 text-foreground focus:outline-none placeholder:text-muted-foreground"
                            rows="2"
                        ...
                        <div class="flex items-center justify-between px-2">
                            <div class="relative flex items-center gap-2 text-xs text-muted-foreground">
                                <button
                                    type="button"
                                    class="inline-flex items-center gap-1 rounded-full border border-border px-2.5 py-1.5 text-foreground hover:bg-muted"
                                ...
                                <span>{move || status_label(locale.get(), chat.status.get())}</span>
                                <Show when=move || show_mode_menu.get()>
                                    <div class="absolute bottom-11 left-0 z-20 w-36 rounded-2xl border border-border bg-card p-1 shadow-lg">
                                        <button
                                            type="button"
                            ...
                            <button
                                type="submit"
                                class="rounded-full bg-primary p-2 text-primary-foreground transition-all hover:scale-105 hover:bg-primary/90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
