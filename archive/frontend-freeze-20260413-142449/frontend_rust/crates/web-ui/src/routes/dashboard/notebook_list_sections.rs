fn notebook_list_sections(
    ...
    let rows = notebooks
        ...
        .map(|notebook| {
            ...
            view! {
                <A
                    href={format!("/dashboard/{}", notebook.id)}
                    attr:class="group grid grid-cols-12 items-center gap-4 border-b border-border/60 px-4 py-3.5 transition-colors hover:bg-muted/30"
                >
                    <div class="col-span-6 flex min-w-0 items-center gap-3 pr-2">
                        <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-muted text-sm font-medium text-foreground">
                            {icon_label}
                        </div>
                        <div class="min-w-0">
                    ...
                    <div class="col-span-2 text-[13px] text-muted-foreground">
                    ...
                    <div class="col-span-2 flex items-center justify-between gap-2">
                        <span class="text-[13px] text-muted-foreground">{role_label}</span>
