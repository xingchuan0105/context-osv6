        ...
        .map(|notebook| {
            ...
            view! {
                <A
                    ...
                    attr:class="group relative block h-[188px] rounded-2xl border border-border/80 bg-card px-5 py-4 transition-all duration-150 hover:border-zinc-300 hover:shadow-sm"
                >
