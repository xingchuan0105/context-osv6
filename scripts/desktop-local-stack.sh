...
# Product processes: bash scripts/desktop-local-product.sh ensure
...
# Local product API (offset from product-dev :8080)
...
# Required for release avrag-api JWT (stable per install via jwt.secret)
JWT_SECRET=${jwt_secret}

# sqlx migrate / first boot; product.sh may set AVRAG_RUN_MIGRATIONS=false after migrate
