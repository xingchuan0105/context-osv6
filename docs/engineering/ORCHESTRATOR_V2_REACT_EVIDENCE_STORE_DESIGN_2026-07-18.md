...
| **V2 — ReAct orchestrator** | orchestrator.yaml loop with delegate/evidence_fetch interception, strategy note, finish-gates, loop guards; worker handoff contract; search-brief de-referencing emerges from the loop. |
