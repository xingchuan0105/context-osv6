...
- [普通 Agent 与仓库树对照实验](plans/2026-09-10-repository-tree-controlled-experiment.md) — 真实 grep／向量混合检索 × 平铺／树导航，典型 20 题各三次、共 240 个答案；四路各并发 2、总上限 8。独立 Windows 原型接口已实现，v2 小批 8/8 通过，完整在线实验执行中。
