...
- [仓库树 128 题纯 RAG 评测](plans/2026-09-10-repository-tree-rag128.md) — 128/128 完成、123 PASS；含历史完整 SaC 对照，分开报告 128 题历史成绩与 119 道未变更题，披露引用和裁判差异。
- [普通 Agent 与仓库树对照实验](plans/2026-09-10-repository-tree-controlled-experiment.md) — 真实 grep／向量混合检索 × 平铺／树导航，典型 20 题各三次、共 240 个答案；四路各并发 2、总上限 8。独立 Windows 原型已完成240答案、统一评分和72例AI独立复核；尚未证实树导航有稳定质量增益，详见结论与指标。
