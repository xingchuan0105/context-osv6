...
- 已有 Rust debug（§2.2）、Next 对照（§2.3）、release-like 再采（§2.4）；仍无 30 分钟；核心 p95 未达 ≥20%；体积护栏失败；
...
## 2.4 release-like 再采（2026-09-04）

任务：[`2026-09-04-frontend-rust-phase-0-gate0-release-collect-task.md`](2026-09-04-frontend-rust-phase-0-gate0-release-collect-task.md)。
见数后未改 charter。采集时刻 `2026-09-04T10:29:47Z`。两侧 discarded = 0。

### 环境

| 项 | 实际值 |
|---|---|
| 视口 / 浏览器 / 网络 / 夹具 | 与 §2.3 相同 |
| Rust 产物 | **`cargo leptos build --release`**：`target/release/web-server` + `target/site`（`web_ui.wasm` 1.4MB），`http://127.0.0.1:3200` |
| Next 产物 | 同 §2.3：standalone `:3000`；API `:18081` |
| 采集开关 | `GATE0_RUST_PROFILE=release`；web-server `reuseExistingServer=false` |

### 核心 p95（本轮同机；仍不得 GO）

| id | Rust release median / p95 | Next median / p95 | Rust 相对 Next |
|---|---|---|---|
| `stream_first_token_ms` | 222.1 / **229.0** | 250.0 / **268.0** | 快 **14.6%**（未达 ≥20%） |
| `stream_complete_ms` | 1507.9 / **1527.8** | 1520.8 / **1540.7** | 快 **0.8%**（未达 ≥20%） |

相对 §2.3 debug：first p95 234.8→229.0，complete 1531.6→1527.8。释放优化几乎不改变流式墙钟（夹具 97×15ms 仍是主因）。

### 护栏

| id | Rust release p95 | Next p95 | 判定 |
|---|---|---|---|
| `nav_lcp_ms` | 108 | 428 | Rust 未回退 |
| `encoded_transfer_bytes` | 1_462_689 | 563_894 | **仍约 2.6× Next**（debug 曾是 12×）。护栏失败 |
| `heap_used_after_stream` | 10_000_000（分桶） | 16_100_000 | 不能比斜率 |
| `long_frame_count` | 0 | 0 | 未回退 |
...
| # | kind | first | complete | heap | long | chars |
|---|---|---|---|---|---|---|
| 1 | cold | 229.0 | 1510.0 | 10000000 | 0 | 242 |
| 2 | cold | 230.1 | 1526.4 | 10000000 | 0 | 242 |
| 3 | cold | 222.5 | 1502.5 | 10000000 | 0 | 242 |
| 4 | cold | 227.7 | 1512.0 | 10000000 | 0 | 242 |
| 5 | cold | 224.5 | 1527.8 | 10000000 | 0 | 242 |
| 6 | hot | 225.6 | 1529.3 | 10000000 | 0 | 242 |
| 7 | hot | 219.6 | 1514.2 | 10000000 | 0 | 242 |
| 8 | hot | 222.5 | 1516.8 | 10000000 | 0 | 242 |
| 9 | hot | 222.1 | 1479.8 | 10000000 | 0 | 242 |
| 10 | hot | 226.4 | 1518.8 | 10000000 | 0 | 242 |
| 11 | hot | 218.7 | 1491.5 | 10000000 | 0 | 242 |
| 12 | hot | 216.7 | 1491.2 | 10000000 | 0 | 242 |
| 13 | hot | 218.7 | 1508.1 | 10000000 | 0 | 242 |
| 14 | hot | 222.2 | 1496.5 | 10000000 | 0 | 242 |
| 15 | hot | 220.5 | 1498.3 | 10000000 | 0 | 242 |
| 16 | hot | 220.8 | 1498.0 | 10000000 | 0 | 242 |
| 17 | hot | 220.5 | 1496.9 | 10000000 | 0 | 242 |
| 18 | hot | 217.0 | 1488.5 | 10000000 | 0 | 242 |
| 19 | hot | 223.8 | 1506.5 | 10000000 | 0 | 242 |
| 20 | hot | 220.7 | 1515.6 | 10000000 | 0 | 242 |
| 21 | hot | 223.1 | 1510.3 | 10000000 | 0 | 242 |
| 22 | hot | 221.2 | 1517.4 | 10000000 | 0 | 242 |
| 23 | hot | 222.3 | 1507.9 | 10000000 | 0 | 242 |
| 24 | hot | 220.6 | 1495.8 | 10000000 | 0 | 242 |
| 25 | hot | 220.8 | 1502.3 | 10000000 | 0 | 242 |

### Next 流式（本轮 5 冷 + 20 热）

| # | kind | first | complete | heap | long | chars |
|---|---|---|---|---|---|---|
| 1 | cold | 268.0 | 1540.0 | 17100000 | 0 | 8 |
| 2 | cold | 263.6 | 1542.2 | 10600000 | 0 | 8 |
| 3 | cold | 264.2 | 1536.6 | 16100000 | 0 | 8 |
| 4 | cold | 268.7 | 1540.7 | 16100000 | 0 | 8 |
| 5 | cold | 260.2 | 1525.0 | 16100000 | 0 | 8 |
| 6 | hot | 264.0 | 1538.3 | 15200000 | 0 | 8 |
| 7 | hot | 252.8 | 1510.8 | 15200000 | 0 | 8 |
| 8 | hot | 246.3 | 1507.0 | 15200000 | 0 | 8 |
| 9 | hot | 252.3 | 1520.2 | 15200000 | 0 | 8 |
| 10 | hot | 252.5 | 1520.8 | 15200000 | 0 | 8 |
| 11 | hot | 248.8 | 1529.1 | 15200000 | 0 | 8 |
| 12 | hot | 245.7 | 1514.6 | 15200000 | 0 | 8 |
| 13 | hot | 250.1 | 1524.5 | 15200000 | 0 | 8 |
| 14 | hot | 248.3 | 1516.9 | 15200000 | 0 | 8 |
| 15 | hot | 249.0 | 1523.0 | 15200000 | 0 | 8 |
| 16 | hot | 249.5 | 1530.8 | 15200000 | 0 | 8 |
| 17 | hot | 248.0 | 1514.8 | 15200000 | 0 | 8 |
| 18 | hot | 250.0 | 1531.3 | 15200000 | 0 | 8 |
| 19 | hot | 250.3 | 1516.8 | 15200000 | 0 | 8 |
| 20 | hot | 245.5 | 1518.0 | 15200000 | 0 | 8 |
| 21 | hot | 250.0 | 1535.9 | 15200000 | 0 | 8 |
| 22 | hot | 251.1 | 1514.8 | 15200000 | 0 | 8 |
| 23 | hot | 246.2 | 1508.4 | 15200000 | 0 | 8 |
| 24 | hot | 249.3 | 1510.3 | 15200000 | 0 | 8 |
| 25 | hot | 247.0 | 1502.7 | 15200000 | 0 | 8 |

### 本轮仍未满足的 GO 条件

1. 核心两项相对 Next 均未 ≥20%（14.6% / 0.8%）。流式墙钟被夹具节奏绑死，release 几乎帮不上。
2. 体积护栏仍失败（1.46MB vs 0.56MB）。
3. 30 分钟堆斜率未跑；`usedJSHeapSize` 仍不可用。
4. 未改 charter、未部署、未进 Phase 1–6。
