...
type ContextOsMarkProps = {
  className?: string;
  style?: CSSProperties;
  /** Display size in CSS px (or any CSS length via style). Default 24 for nav slots. */
  size?: number;
  /** Accessible title when mark is meaningful (omit for decorative). */
  title?: string;
};
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth="2.4"
      />
      <path d="M38 17.5V58.5" stroke={ink} strokeLinecap="round" strokeWidth="2.2" />
      <path d="M29.5 31.5H38" stroke={ink} strokeLinecap="round" strokeWidth="2" />
      <path d="M38 25.5H45" stroke={ink} strokeLinecap="round" strokeWidth="2" />
      <path d="M38 44.5H47" stroke={ink} strokeLinecap="round" strokeWidth="2" />
      <path d="M38 52H45" stroke={ink} strokeLinecap="round" strokeWidth="2" />
      <path
