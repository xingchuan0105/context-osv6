...
export function createSettingsSurfaceMocks() {
  ...
  return {
    ...
    listTopupPacksMock: vi.fn(),
    listProviderSecretsMock: vi.fn(),
...
export function createAdminSurfacesMocks() {
  return {
    ...
    getAdminAccountMock: vi.fn(),
    listAdminUsersForAccountMock: vi.fn(),
    getAdminUsageForAccountMock: vi.fn(),
    updateAdminAccountBlockedMock: vi.fn(),
