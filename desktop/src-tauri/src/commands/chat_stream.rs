...
use super::license::{get_license_status, handle_deep_link_url, license_allows_chat};
...
pub async fn chat_stream(
    ...
    let result = run_desktop_chat(&app, &request, &cancel, |event| emit_or_stop(&app, event)).await;
