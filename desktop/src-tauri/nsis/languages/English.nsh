...
LangString COS_WELCOME_TEXT ${LANG_ENGLISH} "This wizard will install $(^NameDA) on your computer.$\r$\n$\r$\nLocal knowledge base with Vector Graph RAG. License-first — no cloud login required for core use.$\r$\n$\r$\nClick Next to continue."
...
LangString COS_UNWELCOME_TITLE ${LANG_ENGLISH} "Uninstall Context-OS Client"
LangString COS_UNWELCOME_TEXT ${LANG_ENGLISH} "This wizard will remove $(^NameDA) from your computer.$\r$\n$\r$\nClick Next to continue."
LangString COS_UNFINISH_TITLE ${LANG_ENGLISH} "Uninstall complete"
LangString COS_UNFINISH_TEXT ${LANG_ENGLISH} "$(^NameDA) has been removed from your computer.$\r$\n$\r$\nClick Finish to close this wizard."
LangString COS_LICENSE_TOP ${LANG_ENGLISH} "Please review the license terms before installing Context-OS Client."
LangString COS_LICENSE_BOTTOM ${LANG_ENGLISH} "If you accept the terms of the agreement, click I Agree to continue. You must accept the agreement to install $(^NameDA)."
LangString COS_LICENSE_BUTTON ${LANG_ENGLISH} "I Agree"
