...
|9.3|Workspace 管理|✅|`workspace-top-bar.tsx` 含 "新建笔记本" 按钮，支持 workspace 级 create/update/title edit CRUD|
...
|#|功能点|状态|代码证据|
|-|-|-|-|
|11.1|私有 Workspace (默认)|✅|`share/` crate|
...
* 18 项功能中 14 项已实现，2 项部分实现（引用跳转锚点定位、乐观更新），2 项未实现（Workspace CRUD、引用一致性校验）
